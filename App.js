...
const RestaurantCard = (props) => {
  ...
  let {name,cuisines,costForTwo,avgRating,deliveryTime,cloudinaryImageId} =restaurantData?.data
  ...
  return (
    <div className="body">
      ...
      <div className="restaurant-container">
        {
        resList.map(restaurant => <RestaurantCard key={restaurant.data.id} restaurantData = {restaurant} />)
        }
      </div>
    </div>
  );
